...
public class EventVO {
	...
	public String toString() {
		return "EventVO [event_number=" + event_number + ", attach_number=" + attach_number + ", uNo=" + uNo
				+ ", hit_count=" + hit_count + ", event_title=" + event_title + ", event_content=" + event_content
				+ ", write_date=" + write_date + ", event_tel=" + event_tel + ", event_start=" + event_start
				+ ", event_end=" + event_end + ", event_local=" + event_local + ", LType=" + LType
